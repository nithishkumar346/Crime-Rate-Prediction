...
def predict_result():
    ...
    population = {
        '0': 63.50, '1': 85.00, '2': 67.50, '3': 21.50, '4': 200.50, '5': 23.60, '6': 77.50, '7': 21.70,
        '8': 30.70, '9': 29.20, '10': 21.20, '11': 14.10, '12': 20.30, '13': 29.00, '14': 18.20,
    ...
    # Population adjustment (assuming 3.35% growth per year)
    year_diff = int(year) - 2011
    pop = pop + 0.0461 * year_diff * pop
